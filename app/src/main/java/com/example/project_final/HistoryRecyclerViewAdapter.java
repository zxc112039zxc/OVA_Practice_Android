...
public class HistoryRecyclerViewAdapter extends RecyclerView.Adapter<HistoryRecyclerViewAdapter.ViewHolder> {
    ...
    public HistoryRecyclerViewAdapter(ArrayList<Problem> arrayList) {
...
//                    if (problem.get(0).toLowerCase().contains(constraint.toString().toLowerCase()) || problem.get(1).toLowerCase().contains(constraint.toString().toLowerCase())) {
