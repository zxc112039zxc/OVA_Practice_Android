...
public class SearchRecyclerViewAdapter extends RecyclerView.Adapter<SearchRecyclerViewAdapter.ViewHolder> implements Filterable {
    ...
    public SearchRecyclerViewAdapter(ArrayList<Problem> arrayList) {
...
//                    , Toast.LENGTH_SHORT).show();
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.problem_search_item,parent,false);
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                for (Problem problem: arrayListFilter) {
                    if (problem.getProblemNumber().toLowerCase().contains(constraint.toString().toLowerCase()) || problem.getProblemName().toLowerCase().contains(constraint.toString().toLowerCase())) {
