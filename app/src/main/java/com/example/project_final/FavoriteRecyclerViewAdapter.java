...
public class FavoriteRecyclerViewAdapter extends RecyclerView.Adapter<FavoriteRecyclerViewAdapter.ViewHolder> implements Filterable {

    ArrayList<Problem> arrayList;
    ArrayList<Problem> arrayListFilter;

    public FavoriteRecyclerViewAdapter(ArrayList<Problem> arrayList) {
...
//                    , Toast.LENGTH_SHORT).show();
    ...
    Filter mFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0 || constraint != "favorite") {
